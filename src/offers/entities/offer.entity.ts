...
export class Offer implements IOffer {
  ...
  @Column({ type: 'integer', width: 1, default: 0, name: 'is_desktop' })
  isDesktop: number;

  // indicates if offer is available for android
  @Column({ type: 'integer', width: 1, default: 0, name: 'is_android' })
  isAndroid: number;

  // indicates if offer is available for ios
  @Column({ type: 'integer', width: 1, default: 0, name: 'is_ios' })
  isIos: number;
